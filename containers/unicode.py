...
class NormalizedStr:
    ...
    def __repr__(self):
        ...
        '''
        return "NormalizedStr(\'{}\', \'{}\')".format(self.text, self.nf)
    ...
    def __contains__(self, substr):
        ...
        '''
        norm_ss = unicodedata.normalize(self.nf, substr)
        return str(self.text).__contains__(str(norm_ss))
    ...
    def __add__(self, b):
        ...
        '''
        new_text = unicodedata.normalize(self.nf, self.text + unicodedata.normalize(self.nf, str(b)))
        return NormalizedStr(new_text, self.nf)
